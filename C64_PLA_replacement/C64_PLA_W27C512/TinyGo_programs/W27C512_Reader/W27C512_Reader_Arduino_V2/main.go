// W27C512 Reader 64K - Arduino MEGA Version V2
// Gustavo Murta   2024_10_04
// tinygo version 0.32.0 windows/amd64 (using go version go1.22.4 and LLVM version 18.1.2)
// C:\Users\jgust\tinygo\programas\programador_eprom\EEPROM WC27C512 Programmer\W27C512_Reader_Arduino
...
func main() {
	...
	avr.PORTA.Set(0xFF) // set Memory address A0 to A7 = 1
	avr.PORTC.Set(0xFF) // set Memory address A8 to A15 = 1
